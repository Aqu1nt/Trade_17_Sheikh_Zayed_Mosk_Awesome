...
function type_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_control( 'header_layout', array(
		...
		'choices'  => array(
			...
			'header-layout4' => __('Site Title left + Menu over Header Image', 'type'),
	) ) );
	...
	$wp_customize->add_control( 'show_featured_posts', array(
	    ...
	    'description' => __( 'Check this option to highlight some content to your visitors at the top of the Page.', 'type' ),

					...
					<div class="ipnrm-ui-block" x-ng-class="{'ipnrm-ui-folded': appData.config.foldedSections.actions}">
						...
						<div class="ipnrm-ui-block-data">
							...
							<div class="ipnrm-ui-control">
								...
								<div class="ipnrm-ui-helper"><div class="ipnrm-ui-tooltip"><?php echo __('Enable/disable limits for the pitch parameter.', 'ipanorama'); ?></div></div>
								...
								<div class="ipnrm-ui-global-cfg" x-ng-class="{'ipnrm-ui-active': appData.config.global.pitchLimits}">
									...
									<div x-checkbox class="ipnrm-ui-standard ipnrm-ui-orange" x-ng-model="appData.config.global.pitchLimits" title="<?php echo __('Check to use global settings', 'ipanorama'); ?>"></div>
								</div>
							</div>
							...
							<div class="ipnrm-ui-control" x-ng-if="appData.config.pitchLimits">
								...
								<div class="ipnrm-ui-label"><?php echo __('Top limit [-90, 90]', 'ipanorama'); ?></div>
								...
								<div class="ipnrm-ui-global-cfg" x-ng-class="{'ipnrm-ui-active': appData.config.global.pitchLimitsTop}">
									...
									<div x-checkbox class="ipnrm-ui-standard ipnrm-ui-orange" x-ng-model="appData.config.global.pitchLimitsTop" title="<?php echo __('Check to use global settings', 'ipanorama'); ?>"></div>
								</div>
							</div>
							
							<div class="ipnrm-ui-control" x-ng-if="appData.config.pitchLimits">
								<input class="ipnrm-ui-text" type="number" step="any" x-ng-model="appData.config.pitchLimitsBottom">
								<div class="ipnrm-ui-label"><?php echo __('Bottom limit [-90, 90]', 'ipanorama'); ?></div>
								...
								<div class="ipnrm-ui-global-cfg" x-ng-class="{'ipnrm-ui-active': appData.config.global.pitchLimitsBottom}">
									...
									<div x-checkbox class="ipnrm-ui-standard ipnrm-ui-orange" x-ng-model="appData.config.global.pitchLimitsBottom" title="<?php echo __('Check to use global settings', 'ipanorama'); ?>"></div>
								</div>
							</div>
